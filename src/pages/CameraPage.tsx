...
import { Camera, CameraDeviceFormat, CameraRuntimeError, Frame, FrameProcessorPerformanceSuggestion, frameRateIncluded, PhotoFile, sortFormats, useCameraDevices, useFrameProcessor, VideoFile } from 'react-native-vision-camera';
...
interface Props extends StackScreenProps<NavigateStackParams, 'CameraPage'>{};
...
export const CameraPage = ({ navigation }: Props) => {
  ...
  //#region Callbacks
  // const setIsPressingButton = (_isPressingButton: boolean) => {
  ...
  //   setIsCameraInitialized(true);
  // }, []);
  const onMediaCaptured = (media: PhotoFile | VideoFile, type: 'photo' | 'video') => {
  ...
  const onFrameProcessorSuggestionAvailable = (suggestion: FrameProcessorPerformanceSuggestion) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ color: 'black'}}>CameraPage</Text>
    </View>
  )
}
